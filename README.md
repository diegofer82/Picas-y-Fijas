...
La nota juzga la decisión, no la suerte. Se compara el intento con el mejor que encuentra el motor sobre la misma muestra de posibles, midiendo el grupo más grande que deja cada uno: un intento que parte bien la lista es bueno aunque el resultado saliera flojo, y uno que no descartó nada está desperdiciado aunque acertara a continuación. Un turno perdido al tiempo no recibe nota, porque no hubo decisión.
