...
Al pulsar un nombre se abre su ficha, que empieza por el **usuario** —con la fecha de su último cambio de nombre, si lo hubo— y el **email**, marcado como verificado o sin verificar. El correo solo viaja en la ficha (`adminUserDetail`); la lista no lo carga.
