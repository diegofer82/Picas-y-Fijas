/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 78bd221b67567e5da27d8cf468f5f4ba)
// Runtime types generated with workerd@1.20260730.1 2026-08-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	FEEDBACK_MAIL: SendEmail;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	SESSION_TTL_HOURS: "168";
	ADMIN_PATH: "/admin";
	TURNSTILE_ENABLED: "1";
	TURNSTILE_HOSTNAMES: "picasyfijas.fans,www.picasyfijas.fans";
	DEBUG_ERRORS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_TTL_HOURS" | "ADMIN_PATH" | "TURNSTILE_ENABLED" | "TURNSTILE_HOSTNAMES" | "DEBUG_ERRORS">> {}
}
